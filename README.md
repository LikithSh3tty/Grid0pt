...
- **The paper cites no prior work.** It is written and renders from `python -m evaluation.paper`, but its final section records that it attributes nothing. The literature search has not been done; a submitted version needs one.
